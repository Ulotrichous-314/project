...
// Mon Oct 20 14:44:37 2014 by ROOT version 5.34/04
// from TTree ReduceTree/ReduceTree
// found on file: /vols/ssd00/lhcb/stc09/Kstmm/Red_Dataset_withBDT_diagACP.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/vols/ssd00/lhcb/stc09/Kstmm/Red_Dataset_withBDT_diagACP.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/vols/ssd00/lhcb/stc09/Kstmm/Red_Dataset_withBDT_diagACP.root");
      }
